...
%>
		...
		<section class="container mt-5 mb-5" style="max-width: 1000px;">
			<div class="jumbotron" style="padding-top: 20px; margin-top: 50px; height:700px;">
				...
				<form action="observationUpdateAction.jsp?observationID=<%=observationID %>" method="post">
					<div class="container">
					<br>
						...
						<div class="form-row">
							...
							<div class="form-group col-sm-8">
								<label>제목</label>
								<input type="text" name="observationTitle" class="form-control" maxlength="30" value="<%=observationDTO.getObservationTitle()%>">
							</div>
						</div>
						<div class="form-group" style="padding:1.5rem;">
							<label>내용</label>
							<textarea name="observationContent" class="form-control" maxlength="2048" style="height:350px;"><%=observationDTO.getObservationContent()%>
							</textarea>
						</div>
					</div>	
					<br>
					<a href="observation.jsp" class="btn btn-danger pull-left" style="margin-left:3rem;">취소</a>
					<input type="submit" class="btn btn-primary pull-right" style="margin-right:3rem;" value="수정">
				</form>
